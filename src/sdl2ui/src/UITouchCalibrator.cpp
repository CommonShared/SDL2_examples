...
bool UITouchCalibrator::calibrate(EGalax *eGalax)
{
	...
	UICaption *caption = new UICaption(id_Any, screenSize->x/2-100,  40, 0, 0, "Tap the center marker.",  TTF_TEXT_SIMSUN, 24, UIGUI::White,  rightAdjust);
	UITouchCalibratorControl *calibCtrl = new UITouchCalibratorControl(id_Any, 0, 0, screenSize->x, screenSize->y, UIGUI::Black, kMsgTap);
	UIButton *button = new UIButton(id_Any, screenSize->x/2-100, screenSize->y-80, 200, 40, event_Quit,   "Cancel", TTF_TEXT_SIMSUN, 24, UIGUI::White);
