...
void UIMenu::addCmd(string name, int32_t cmd)
{
	...
	mScreen->AddElement((UIElement *) new UIButton(id_Any, screenSize->x/2-BUTTON_WIDTH/2, BUTTON_LIST_TOP+(BUTTON_HEIGHT+BUTTON_VSPACE)*mButtonCount, BUTTON_WIDTH, BUTTON_HEIGHT, cmd, name, TTF_TEXT_SIMSUN, 24, UIGUI::White));
	mButtonCount++;
}
